...
public class WTAFragment extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    SwipeRefreshLayout reflesh;
  RecyclerView liveList;
  static List<LiveItem> liveItems = new ArrayList<>();
  static Bitmap mainPhoto;
  private   WTAFragment instance=null;
  ...
  public   WTAFragment newInstance(String param1, String param2,Context context) {
