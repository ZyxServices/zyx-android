...
public class NBAFragment extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
  SwipeRefreshLayout reflesh;
  RecyclerView liveList;
  static List<LiveItem> liveItems = new ArrayList<>();
  static Bitmap mainPhoto;
  private   NBAFragment instance=null;
  ...
  public   NBAFragment newInstance(String param1, String param2,Context context) {
