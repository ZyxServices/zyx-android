 ...
 */
public class PackRangeActivity extends ImmersiveActivity {
    private ImageView ivSetRangeBack;
    private RadioGroup rgSetRange;
    private TextView tvSetRangeSave;
    private RadioGroup.OnCheckedChangeListener mylist;
    private String str;
    ...
    private void setview() {
        ...
        mylist = new RadioGroup.OnCheckedChangeListener(){
            @Override
        ...
        rgSetRange.setOnCheckedChangeListener(mylist);
