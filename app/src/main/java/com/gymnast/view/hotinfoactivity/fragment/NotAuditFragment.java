...
import com.gymnast.view.hotinfoactivity.adapter.AuditAdapter;
 ...
 */
public class NotAuditFragment extends Fragment {
    ...
    public Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
                switch (msg.what){
                    case HANDLER_UPDATA:
                        adapter=  new AuditMainAdapter(getActivity(),MainList);
